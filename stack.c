...
static Stack CreatStack(int MaxElements)
{
    ...
    if (MaxElements < MinStackSize) {
        error_at_line(1, (int)NULL, __FILE__, __LINE__, "%s", "Stack size is too small");
    }
...
{
    if (IsFull(S)) {
        error_at_line(1, (int)NULL, __FILE__, __LINE__, "%s", "Full stack!!!");
    }
    else {
...
{
    if (IsEmpty(S)) {
        error_at_line(1, (int)NULL, __FILE__, __LINE__, "%s", "Empty stack!!!");
    }
    else {
